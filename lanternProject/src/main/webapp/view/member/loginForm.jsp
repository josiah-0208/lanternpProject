        ...
        <div>
           <div class="panel shadow1">
                <form class="login-form" name="frm">
                    ...
                    <input type="submit" id="login-form-submit" class="login_form button animated fadeInUp animate4" value="Log in" formaction="loginResult.do" onclick="return logchk()">
