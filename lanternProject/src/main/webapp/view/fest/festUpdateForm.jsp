		...
		<form action="festUpdateResult.so?fno=${festival.fno }" method="post" name="frm" enctype="multipart/form-data">
			...
			<div class="txt">
				<div class="txt_tag">
					...
					<textarea wrap="hard" name="f_txt" placeholder="상세 정보를 입력하세요.">${festival.f_txt }</textarea>
			</div>
			<div class="line">
				<div class="line-tag">
					포스터
				...
				<div class="thumbnail">
					<label for="f1">${festival.thumbnail }</label>
					<input type="file" id="f1" name="thumbnail" required>
				</div>
			</div>
			<div class="line">
				<div class="line-tag">
