...
'2022 한강페스티벌_f_image', '서울의 대표적인 문화·휴식 공간이자, 세계인이 사랑하는 글로벌 관광 명소 한강! 
일 년 내내 언제나, 누구나 즐길 수 있는 사계절 축제 <한강페스티벌>이 개최된다. 계절마다 다채로운 여가 프로그램으로 
한강의 숨은 매력을 찾아 휴식과 즐거움을 선사한다.
...
'부산불꽃축제_f_image', '매년 광안리해수욕장을 화려하게 수놓는 부산불꽃축제가 어느덧 17회를 맞이하였다. 
2005년 APEC정상회의 기념행사 일환으로 시작돼, 해를 거듭할수록 세계적인 관심을 받으며 부산 대표 축제로 자리매김하였다. 
부산에서만 볼 수 있는 초대형 불꽃과 광안대교 경관조명을 활용한 미디어파사드 연출, 화려한 불꽃과 조명, 음악이 어우러져 
...
'가을의 예_f_image', '2022 무형유산이음축제가 오는 10월 8일(토)부터 9일(일)까지 전주 덕진공원 일대에서 열린다. 
2022 무형유산이음축제의 슬로건은 "잇다, 無에서 YOU로"이다. 덕진공원에서 전라북도의 다양한 무형유산과 시민을 이을 수 
있는 프로그램을 조성하여 전 세대가 이어질 수 있는, 누구나 즐기고! 느끼고! 머무며! 배우는! 참여형 축제이다.
');
...
'강릉문화재야행_f_image', '강릉의 야간 문화재 향유 프로그램으로 야간에 보고 즐기는 문화재 및 공연, 전시 프로그램이 
다채롭게 진행된다. 야행은 강릉대도호부 관아 일원에서 펼쳐진다.
');
...
'백제문화제_f_image', '<백제의 왕도(王都),충청남도 공주시와 부여군에서 개최되는 역사문화축제>
68년을 이어온 백제문화제는 고대 동아시아의 문화강국이었던 백제의 전통성에 근거하여 백제의 수도였던 충청남도 공주시와 
...
'제주레저힐링축제_f_image', '레저스포츠와 문화예술이 어우러진 「융합형 관광 문화 축제」, 레저스포츠가 가진 역동성을 
함께하는 「체험형 액티비티 축제」,제주형 문화․예술로 힐링을 나누는 「감성 문화 축제」,지역민과 직접 참여하고 만들어가는 
「지역 밀착형 축제」이다. 환경을 생각하는 행사 운영으로 축제의 지속가능성을 확보한다. 제주의 대표적인 콘텐츠, 
...
INSERT INTO FEST(FNO, FNAME, THUMBNAIL, START_DATE, END_DATE, HOURS, INTRO, HOST, LOC, ADDR, 
SPOT, HOME_PG, TEL, FEE, FEE_ADULT, FEE_TEEN, FEE_CHILD, F_IMAGE, F_TXT) 
VALUES (2, '조치원봄꽃축제', '조치원봄꽃축제_thumbnail.jpg', TO_DATE('2034-09-27 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 
TO_DATE('2036-12-31 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '오전 10:00 ~ 오후 6:00', 
'우리동네 여기저기 꽃피었네', '세종특별자치시 조치원읍', '충청지역', '온라인개최',
'온라인개최', 'http://www.flowerfestival.kr', '044-301-5052', 0, 0, 0, 0,
'조치원봄꽃축제_f_image', '2021조치원봄꽃축제는 4/1~4/11, 11일 간 온라인으로 개최된다.
...
'고양가을꽃축제_f_image', '"일산호수공원에서 가을여행 할까요?"
깊어 가는 가을, 꽃의 아름다움과 자연, 문화, 예술의 풍요로움을 만끽할 수 있는 고양가을꽃축제는 우리에게 익숙했던 
호수공원의 아름다움을 새롭게 발견하고, 또 다른 ‘나’를 만나게 되는 가을꽃여정을 담았다.');
